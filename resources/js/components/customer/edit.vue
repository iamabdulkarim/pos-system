                                    ...
                                    >
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="exampleFormControlTextarea1"><b>Customer Mail</b></label>
                                                    <input
                                                        type="email"
                                                        class="form-control"
                                                        id="exampleInputFirstName"
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                     <label for="exampleFormControlTextarea1"><b>Customer Phone Number</b></label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        id="exampleInputFirstName"
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <label for="exampleFormControlTextarea1"><b>Customer Photo</b></label>
                                                    <input
                                                        type="file"
